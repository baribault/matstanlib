function essplots(samples,diagnostics,parameterRequest,varargin)
%ESSPLOTS generates a duo of diagnostic effective sample size (ESS) plots. 
% 
...
% 
% 
% ESSPLOTS(SAMPLES,PARAMETERREQUEST)
...
% ESSPLOTS(SAMPLES,DIAGNOSTICS,PARAMETERREQUEST, ...
...
% 
% 
% See also COMPUTEESS, ESSPLOT, ESSQUANTILEPLOT, ESSINTERVALPLOT, RANKPLOTS
% 

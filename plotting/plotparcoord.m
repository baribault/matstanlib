function plotparcoord(samples,diagnostics,parameterRequest)
%PLOTPARCOORD creates a parallel coordinate plot for parameter instances. 
% 
% this function generates a single plot in which each line represents the 
% values of all parameter values for a single joint posterior sample.  
% 
% optionally, samples resulting from divergent transitions are highlighted
% in red.  
